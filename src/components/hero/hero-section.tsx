  ...
  return (
    <div className="bg-[#F8FAFC] pb-16 pt-14 sm:pb-20 sm:pt-20">
      <div className="mx-auto max-w-2xl px-6 text-center">
        ...
        <h1 className="mt-4 text-3xl font-extrabold leading-[1.1] tracking-tight text-ink sm:text-4xl">
          Călătorii interurbane. Simplu, rapid și digital.
        </h1>
        <p className="mx-auto mt-3 max-w-lg text-md text-ink-secondary">
          Caută orice stație de pe traseu — nu doar capetele de linie — și
          plătești doar segmentul pe care îl parcurgi.
        </p>
      </div>

      <div className="mx-auto mt-9 max-w-2xl px-6">
        <SearchHero />
